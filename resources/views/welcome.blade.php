@php
    $socialPlatforms = [
        ...
        'behance' => [
            'name' => 'Behance',
            'icon' => '<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M9 12h3M9 12a2 2 0 1 1 0-4h3v4M9 12a2 2 0 1 0 0 4h3v-4M18 11.5a3.5 3.5 0 0 0-7 0v1.5h7v-1.5zM14 7h6"/></svg>',
            'default_url' => '#'
        ]
    ];
@endphp
